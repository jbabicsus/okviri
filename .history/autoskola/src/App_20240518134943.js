...
import Profile from './stranice/Instruktor/Profile'; // Importujte Profile komponentu
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path='/instruktor/profile/:userId' element={<ProtectedRoute><Profile /></ProtectedRoute>} />
